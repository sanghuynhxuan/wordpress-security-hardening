...
WordPress security hardening checklist, configuration examples, and incident-response notes.

## Client value

Defense-in-depth configuration, preventive controls, and maintenance processes.
